...
/**
 * OrganizationSearch represents the model behind the search form about `frontend\models\Organization`.
 */
class OrganizationSearch extends Organization
{
    ...
    {
        return [
            [['org_id', 'state_id', 'country_id', 'sector_id', 'field_id', 'enter_by'], 'integer'],
