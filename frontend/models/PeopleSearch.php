...
class PeopleSearch extends People
{
    ...
    {
        return [
            [['people_id', 'race', 'religion', 'marital_status', 'no_of_children', 'income', 'spending', 'enter_by', 'verified_by', 'mukim_id'], 'integer'],
            [['name', 'ic_no', 'address', 'postcode', 'dob', 'gender', 'name_nick', 'ic_no_old', 'current_address', 'state_id', 'district_id', 'sub_base_id', 'cluster_id', 'kampung_id', 'birth_place', 'citizen', 'profession_status', 'profession', 'job_position', 'job_else', 'mobile_no', 'home_no', 'email', 'penghulu', 'local_champion', 'volunteer', 'micro_worker', 'image', 'enter_date', 'data_status', 'verified_date', 'flag', 'mukim', 'tarikh_soal_selidik', 'nota', 'ruang_cadangan', 'oku', 'tanggungan_oku', 'bahagian_id'], 'safe'],
        ];
    }
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere(['like', 'name', $this->name])
            ...
            ->andFilterWhere(['like', 'oku', $this->oku])
