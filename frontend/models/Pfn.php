 ...
 * @property integer $rating_kemudahan_asas
 ...
 * @property integer $rating_kemudahan_ict
 ...
 * @property integer $rating_bilik_latihan
 * @property integer $rating_equip
 ...
 * @property integer $rating_mesra_oku
 ...
 * @property string $status_rangkaian
 */
class Pfn extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['cat_id', 'kampung_id', 'cluster_id', 'sub_base_id', 'district_id', 'state_id', 'rating_kemudahan_asas', 'rating_kemudahan_ict', 'rating_bilik_latihan', 'rating_equip', 'rating_mesra_oku', 'rating_capaian', 'rating_keseluruhan_pfn', 'enter_by', 'mukim_id'], 'integer'],
            ...
            [['lokasi', 'jantina', 'umur', 'mobile', 'no_tel', 'fax', 'keaktifan_bilik_mesyuarat', 'jantina2', 'umur2', 'mobile2', 'no_tel2', 'fax2'], 'string', 'max' => 15],
    ...
    public function attributeLabels()
    {
        return [
            ...
            'pfn_code' => 'Pfn Code',
            'date' => 'Date',
            'pfn_name' => 'Public Facility Network',
            'cat_id' => 'Kategori',
            'lokasi' => 'Lokasi',
            'alamat' => 'Alamat',
            'poskod' => 'Poskod',
            ...
            'jarak_pfn_komuniti' => 'Jarak Pfn Komuniti',
            ...
            'nota' => 'Nota',
            'nama_pengurus2' => 'Nama Pengurus2',
            'no_kp2' => 'No Kp2',
            'no_kp_old2' => 'No Kp Old2',
            'jantina2' => 'Jantina2',
            'umur2' => 'Umur2',
            'mobile2' => 'Mobile2',
            'no_tel2' => 'No Tel2',
